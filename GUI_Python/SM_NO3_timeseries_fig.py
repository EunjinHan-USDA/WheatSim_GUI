...
#==============================================================================
def SM_NO3_timeseries_fig(id_str: str, file_path_root: Path,):
    ...
    fig.suptitle('Soil water content:  ' +id_str) 
    c_list = ['k', 'C1', 'C2','C3','C4','C5', 'C6','C7'] 
    marker_list = ["^", ".","+",".",".",".","."] #, "p", "h", "D", "X"]

    #1)read g03 and g07
    df_g03 = pd.read_csv(g03_fname, parse_dates=['        Date']) 
